...
public class TenantController implements TenantApi {
  ...
  private final List<String> plainMappingSamples = Collections.singletonList("annex_to_dematic_full.json");
  ...
  private void loadSampleData() {
    ...
    readEntitiesFromFiles(plainMappingSamples, FullMapping.class)
      .forEach(locationMappingsService::postFullMapping);
